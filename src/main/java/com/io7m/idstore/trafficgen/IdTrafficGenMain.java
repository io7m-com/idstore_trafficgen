...
import com.io7m.idstore.trafficgen.internal.IdCmdRun;
...
public final class IdTrafficGenMain implements Runnable
{
  private static final Logger LOG =
    LoggerFactory.getLogger(IdTrafficGenMain.class);
    ...
    final String[] inArgs)
  {
    ...
    builder.addCommand(new IdCmdRun());
  ...
  public static int mainExitless(
    final String[] args)
  {
    final IdTrafficGenMain cm = new IdTrafficGenMain(args);
    cm.run();
    return cm.exitCode();
  }
